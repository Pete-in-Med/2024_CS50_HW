...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    """
    #Initialize probability as 1, in order not to influence the later probability
    probability = 1
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            # go to the PROBS to find the unconditional value
            ...
            #the red part about the gene is either from mom or dad
            if genes == 2:
